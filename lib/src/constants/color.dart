...
class ColorConst {
  ...
  //primary
  static const Color primarySkyBlue = Color.fromRGBO(35, 136, 194, 1);

  //form upload file
  static const Color file = Color(0xffdddddd);

  //secondary black
  static const Color secondaryBlack = Color.fromRGBO(68, 68, 68, 1);
  ...
  static Color get  brownish  => const Color(0xff000000);
